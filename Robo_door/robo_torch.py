...
class Agent:
    def __init__(self, actor_learning_rate, critic_learning_rate, input_dims, tau, env,
                 ...
                 layer_1_size=256, layer_2_size=128,
        ...
        self.actor = ActorNetwork(
            ...
            fc1_dims=layer_1_size,
            fc2_dims=layer_2_size,
            n_actions=n_actions,
            name='actor',
    ...
    def learn(self):
        ...
        next_q1 = self.target_critic_1.forward(new_state, target_actions)
        next_q2 = self.target_critic_2.forward(new_state, target_actions)
        ...
        next_critic_value1 = T.min(next_q1, next_q2)

        target = reward + self.gamma * next_critic_value1
